...
public class PauseController : MonoBehaviour
{
    ...
    {
        var isAudioOff = AudioManager.Instance.ToggleAudio();
        soundToggle.sprite = isAudioOff ? soundOff : soundOn;
    }
    ...
    private void Start()
    {
        soundToggle.sprite = EasySave.Load<bool>("Mute") ? soundOff : soundOn;
    }
}
